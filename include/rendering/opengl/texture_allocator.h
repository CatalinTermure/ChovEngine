#ifndef CHOVENGINE_INCLUDE_RENDERING_OPENGL_TEXTUREALLOCATOR_H_
#define CHOVENGINE_INCLUDE_RENDERING_OPENGL_TEXTUREALLOCATOR_H_
...
#endif //CHOVENGINE_INCLUDE_RENDERING_OPENGL_TEXTUREALLOCATOR_H_
