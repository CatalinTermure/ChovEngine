#ifndef CHOVENGINE_INCLUDE_RENDERING_OPENGL_SHADER_H_
#define CHOVENGINE_INCLUDE_RENDERING_OPENGL_SHADER_H_
...
#endif //CHOVENGINE_INCLUDE_RENDERING_OPENGL_SHADER_H_
