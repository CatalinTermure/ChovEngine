#ifndef CHOVENGINE_INCLUDE_RENDERING_OPENGL_TEXTURE_H_
#define CHOVENGINE_INCLUDE_RENDERING_OPENGL_TEXTURE_H_
...
class Texture {
 public:
  ...
  Texture(int cube_length, std::string name, TextureAllocator &allocator);
...
#endif //CHOVENGINE_INCLUDE_RENDERING_OPENGL_TEXTURE_H_
