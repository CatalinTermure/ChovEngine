#ifndef CHOVENGINE_INCLUDE_RENDERING_OPENGL_RENDER_OBJECT_H_
#define CHOVENGINE_INCLUDE_RENDERING_OPENGL_RENDER_OBJECT_H_
...
#endif //CHOVENGINE_INCLUDE_RENDERING_OPENGL_RENDER_OBJECT_H_
