#ifndef CHOVENGINE_INCLUDE_RENDERING_VULKAN_IMAGE_H_
#define CHOVENGINE_INCLUDE_RENDERING_VULKAN_IMAGE_H_
...
#endif //CHOVENGINE_INCLUDE_RENDERING_VULKAN_IMAGE_H_
