#ifndef LABSEXTRA_SRC_RENDERING_VULKAN_VULKAN_RENDERER_CPP_BUFFER_H_
#define LABSEXTRA_SRC_RENDERING_VULKAN_VULKAN_RENDERER_CPP_BUFFER_H_
...
#endif //LABSEXTRA_SRC_RENDERING_VULKAN_VULKAN_RENDERER_CPP_BUFFER_H_
